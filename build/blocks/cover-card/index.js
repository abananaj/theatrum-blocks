/******/ (() => { // webpackBootstrap
/*!****************************************!*\
  !*** ./src/blocks/cover-card/index.js ***!
  \****************************************/
wp.blocks.registerBlockType('chance/cover-card', {
  edit: props => {
    ...
    return wp.element.createElement(Fragment, null, wp.element.createElement(InspectorControls, null, wp.element.createElement('div', {
    ...
    }))), wp.element.createElement('div', blockProps, isLoading && wp.element.createElement(Spinner, null), error && wp.element.createElement('p', {
      className: 'cover-card-error'
    }, 'Error: ' + error), !isLoading && !error && postData && wp.element.createElement('div', {
      ...
      className: 'title'
    }, postData.title || '(No Title)')), attributes.buttonText && wp.element.createElement('a', {
      href: attributes.buttonUrl || '#',
      target: attributes.openInNewWindow ? '_blank' : '_self',
      rel: attributes.openInNewWindow ? 'noopener noreferrer' : '',
      className: 'button'
    }, attributes.buttonText)))), !isLoading && !error && !postData && wp.element.createElement('p', {
