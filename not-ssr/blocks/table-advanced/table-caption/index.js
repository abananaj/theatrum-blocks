...
const captionIcon = (
  ...
  <text style={{ fill: 'rgb(48, 0, 176)', fontFamily: 'Rubik', fontSize: '76.6px', fontWeight: 700, letterSpacing: '7.1px', textTransform: 'capitalize', whiteSpace: 'pre' }} transform="matrix(1, 0, 0, 0.969828, 1.203705, 2.79364)" x="122.542" y="106.558">TITLE</text>
	</svg>
);
