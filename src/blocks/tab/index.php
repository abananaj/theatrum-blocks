...
/**
 * Render callback for theatrum/tab.
 *
...
{
	$tab_index = $block->context['theatrum/tab-index'] ?? 0;
	$tab_id    = $block->context['theatrum/tab-id'] ?? '';
	$tab_label = $block->context['theatrum/tab-label'] ?? '';
...
/**
 * Registers the `theatrum/tab` block on the server.
 *
 * @since 7.0.0
 */
