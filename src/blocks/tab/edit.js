...
function Edit({ context, clientId }) {
	const tabsList = context['theatrum/tabs-list'] || EMPTY_ARRAY;
	const activeTabIndex = context['theatrum/tabs-activeTabIndex'];
	const editorActiveTabIndex = context['theatrum/tabs-editorActiveTabIndex'];
