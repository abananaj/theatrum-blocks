...
The pretitle and subtitle use the plugin's custom **`chance/post-meta`** block-bindings source
...
> type per-page pretitle/subtitle text directly into the block. The `chance/post-meta` binding
