...
- [`theatrum/tab-item`](https://developer.wordpress.org/block-editor/reference-guides/core-blocks/core-blocks-design/core-block-accordion-item/)
...
- `theatrum/tab-icon-position` → attribute `iconPosition`
- `theatrum/tab-show-icon` → attribute `showIcon`
- `theatrum/tab-heading-level` → attribute `headingLevel`
