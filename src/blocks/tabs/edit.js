 ...
 * block entries for theatrum/tab-list or theatrum/tab-panels.
 *
 ...
 */
const TABS_TEMPLATE = [['theatrum/tab-list'], ['theatrum/tab-panels']];
...
function Edit({ clientId, attributes, setAttributes }) {
	...
	const contextValue = useMemo(() => {
		...
		return {
			'theatrum/tabs-list': tabList,
			'theatrum/tabs-id': anchor,
