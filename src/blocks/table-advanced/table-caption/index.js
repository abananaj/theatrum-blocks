...
const captionIcon = (
  ...
  <text style="fill: rgb(48, 0, 176); font-family: Rubik; font-size: 76.6px; font-weight: 700; letter-spacing: 7.1px; text-transform: capitalize; white-space: pre;" transform="matrix(1, 0, 0, 0.969828, 1.203705, 2.79364)" x="122.542" y="106.558">TITLE</text>
	</svg>
);

const TEMPLATE = [ [ 'core/heading', { level: 2, placeholder: 'Table title' } ] ];
