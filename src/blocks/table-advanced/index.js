...
const Edit = ( { attributes, setAttributes, clientId } ) => {
	...
	const onToggleThead = ( value ) => {
		...
		const headerBlock = innerBlocks.find( ( b ) => b.name === 'theatrum/table-header' );
		if ( value && ! headerBlock ) {
			const captionIndex = innerBlocks.findIndex( ( b ) => b.name === 'theatrum/table-caption' );
			insertBlock(
	...
	const onToggleTfoot = ( value ) => {
		...
		const footerBlock = innerBlocks.find( ( b ) => b.name === 'theatrum/table-footer' );
		if ( value && ! footerBlock ) {
			const bodyIndex = innerBlocks.findIndex( ( b ) => b.name === 'theatrum/table-body' );
			insertBlock(
