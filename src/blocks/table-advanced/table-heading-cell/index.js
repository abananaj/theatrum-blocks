...
// v1: original save without serialized color/border; lets existing header cells validate and auto-migrate.
const v1 = {
...
// v2: color/border serialized but before dimensions were also applied manually; lets existing header cells validate and auto-migrate.
const v2 = {
	attributes: metadata.attributes,
	supports: metadata.supports,
	save: ( { attributes } ) => {
