...
const thIcon = (
  ...
  <rect x="7.491" y="43.149" width="98.598" height="151.791" style="fill: rgb(48, 0, 176); transform-box: fill-box; transform-origin: 50% 50%;" rx="41.088" ry="41.088" transform="matrix(0, 1, -1, 0.001578, 54.685905, 46.659229)"/>
  <g id="Layer_31" data-name="Layer 31" transform="matrix(7.627119, 0, 0, 7.627119, 5.932192, 5.779642)" style="">
    <path d="m60 13.7h-56a1.5 1.5 0 0 0 -1.5 1.5v33.6a1.5 1.5 0 0 0 1.5 1.5h17.17v9.7a1.5 1.5 0 0 0 1.5 1.5h18.66a1.5 1.5 0 0 0 1.5-1.5v-9.7h17.17a1.5 1.5 0 0 0 1.5-1.5v-33.6a1.5 1.5 0 0 0 -1.5-1.5zm-35.83 33.6v-8.2h15.66v8.2zm-18.67-19.4h15.67v8.2h-15.67zm34.33 8.2h-15.66v-8.2h15.66zm3-8.2h15.67v8.2h-15.67zm15.67-3h-15.67v-8.2h15.67zm-18.67 0h-15.66v-8.2h15.66zm-34.33-8.2h15.67v8.2h-15.67zm0 22.4h15.67v8.2h-15.67zm34.33 19.4h-15.66v-8.2h15.66zm18.67-11.2h-15.67v-8.2h15.67z" fill="#ff5c01"/>
	...
	return (
		<>
				...
				<PanelBody title="Header Cell Settings">
					<SelectControl
						...
						options={ [
							...
							{ label: 'Column group (colgroup)', value: 'colgroup' },
							{ label: 'Row group (rowgroup)', value: 'rowgroup' },
						] }
					...
					<TextControl
						label="Abbreviation"
						value={ abbr || '' }
						onChange={ ( value ) => setAttributes( { abbr: value } ) }
						help="Short label for this header (used in mobile/narrow contexts)."
					/>
					<TextControl
						label="Headers"
						value={ headers || '' }
						onChange={ ( value ) => setAttributes( { headers: value } ) }
			...
			<div { ...blockProps }>
				<InnerBlocks
					template={ TEMPLATE }
					allowedBlocks={ [ 'core/paragraph', 'core/list', 'core/image', 'core/icon' ] }
				/>
			</div>
		</>
	);
