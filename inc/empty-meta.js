...
console.log("Great-grandparent Element:", firstLink.parentElement.parentElement.parentElement); // <html>...</html>
...
showSiblingsBtn.addEventListener('click', () => {
  ...
  console.log("Next Next Element Sibling:", firstLink.nextElementSibling.nextElementSibling); // <a>HTML</a>
  console.log("Previous Element Sibling:", firstLink.nextElementSibling.previousElementSibling); // firstLink itself
